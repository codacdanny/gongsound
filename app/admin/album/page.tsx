    ...
    <main className="min-h-screen bg-bg pt-8 pb-20 px-5 sm:px-8">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="flex items-center gap-4 mb-12">
          ...
          <h1 className="display text-3xl text-ivory">Featured Album</h1>
        </div>
            ...
            albums.map((album) => (
              ...
              >
                <div className="flex-1">
                  <h3 className="font-bold text-ivory">{album.title}</h3>
                  <p className="text-sm text-gold mt-1">{album.artists}</p>
                  <p className="text-sm text-ivory/60 mt-2 line-clamp-2">
                    {album.description}
                  </p>
                  {album.releaseDate && (
